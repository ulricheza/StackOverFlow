...
<g:formRemote name="postComment${messageInstance?.id}"
	...
	<div style="display:inline-block;width:75%;">
		<g:textArea style="width:100%;resize:none;padding:0 0;border:1px solid;" name="content" 
				value="${commentInstance?.content}" />
	</div>
	...
	<div style="display:inline-block;width:20%;">
		...
		<div id="form-buttons">
			<input style="padding:0 0;margin-left:5px;" type="submit" name="post-comment-button" 
				value="${message(code:"topic.addthecomment.text")}" />
		</div>
	</div>
